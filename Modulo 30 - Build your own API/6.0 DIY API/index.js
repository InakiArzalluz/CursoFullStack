...
app.get("/jokes/:id", (req, res) => {
  ...
  const joke = jokes.find((jk) => id === jk.id);
  if (joke === undefined) {
...
app.get('/filter', (req, res) => {
  const reqJokeType = req.query.type;
  const filteredJokes = jokes.filter((jk) => jk.jokeType === reqJokeType);
